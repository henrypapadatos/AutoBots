...
class Distance2Intersection:
    ...
    def transform_data(self, epoch):
        ...
        for i in range(len(self.node_idcs)):
            ...
            dis_matrix[dis_matrix == 1] = 0
            dis_matrix[dis_matrix == 2] = 1
            dis_matrix[dis_matrix == 3] = 2
            dis_matrix[dis_matrix >= 4] = 3
        ...
        self.pseudo_labels_feats = torch.tensor(list(np.concatenate(self.label))).type(torch.LongTensor).to(self.device)
